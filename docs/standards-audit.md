...
| RFC 9231 section 2.3.6 | Replaces RFC 6931. The ECDSA decoder already selects fixed-width `r || s` for XMLDSig and DER only for an explicitly selected compatibility representation; the obsolete reference was corrected. |
